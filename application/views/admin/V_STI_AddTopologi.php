            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Tambah Topologi</h4>
                  <p class="card-category"> Tambahkan Topologi dibawah ini </p>
                </div>
                <div class="card-body">
				...
				<form action="<?= base_url('/topologiSTI/addTopologiAction'); ?>" method="POST" enctype="multipart/form-data">
				    <input class="form-control" type="text" name="judulTopologi" placeholder="Judul Topologi" value="<?= set_value('judulTopologi'); ?>" ><br>
