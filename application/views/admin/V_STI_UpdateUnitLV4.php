          ...
          <li class="nav-item dropdown active">
            <a class="nav-link" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item active" href="<?= base_url('/unitLV3/viewUnitLV3'); ?>">Unit LV3</a>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Update Unit 2</h4>
                  <p class="card-category"> Update data Unit 2 dibawah ini </p>
                </div>
                <div class="card-body">
					<form action="<?= base_url('/UnitLV4/updateUnitLV4Process'); ?>" method="post">
					    <input type="hidden" name="idL4" value="<?= $unitLV4->idL4; ?>">
					    <input class="form-control" type="text" name="namaUnitL4" placeholder="Nama unit level 4" value="<?= $unitLV4->namaUnitL4; ?>">
					    <?= form_error('namaUnitL4'); ?><br>
					    <input class="form-control" type="text" name="singkatanL4" placeholder="Singkatan unit level 4" value="<?= $unitLV4->singkatanL4; ?>">
					    <?= form_error('singkatanL4'); ?><br>
					    <input class="form-control" type="text" name="koordinatL4" placeholder="Koordinat unit level 4" value="<?= $unitLV4->koordinatL4; ?>">
					    <?= form_error('koordinatL4'); ?><br>
