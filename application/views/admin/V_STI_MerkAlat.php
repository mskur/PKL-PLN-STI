              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="<?= base_url(); ?>merkAlat/addMerk" class="btn btn-primary">Add Merk</a><br>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                            <?php foreach($allMerk as $merk) : ?>
                                <tr>
                                    <th><?= $i; ?></th>
                                    <td><?= $merk->merk; ?></td>
                                    <td>
                                        <form action="<?= base_url(); ?>merkAlat/updateMerk" method="post">
                                            <input type="hidden" name="idMerk" value="<?= $merk->idMerk ?>">
                                            <input class="btn btn-primary" type="submit" name="submit" value="update">
                                        </form>
                                        <form action="<?= base_url(); ?>merkAlat/deletemerk" method="post">
                                            <input type="hidden" name="idMerk" value="<?= $merk->idMerk ?>">
