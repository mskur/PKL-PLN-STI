            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Tambah Merk Alat</h4>
                  <p class="card-category"> Tambahkan Merk Alat dibawah ini </p>
                </div>
                <div class="card-body">
                <form action="<?= base_url('/merkAlat/addMerkProcess'); ?>" method="post">
				    <input class="form-control" type="text" name="merk" placeholder="merk" value="<?= set_value('merk'); ?>">
				    <?= form_error('merk'); ?><br>
