              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="<?= base_url(); ?>UnitLV3/addUnitLV3" class="btn btn-primary">Add Unit Level 3</a><br>
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                            ...
                            <tr>
                                ...
                                <td><?= $u->koordinatL3; ?></td>
                                <td>
                                    <form action="<?= base_url(); ?>UnitLV3/updateUnitLV3" method="post">
                                        <input type="hidden" name="idL3" value="<?= $u->idL3; ?>">
                                        <input class="btn btn-primary" type="submit" name="submit" value="Update">
                                    </form>
                                    <form action="<?= base_url(); ?>UnitLV3/deleteUnitLV3" method="post">
                                        <input type="hidden" name="idL3" value="<?= $u->idL3; ?>">
