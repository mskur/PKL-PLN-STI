            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Topologi Table</h4>
                  <p class="card-category"> Tabel Topologi JBM STI</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="<?= base_url(); ?>topologiSTI/addTopologi" class="btn btn-primary">Add Topologi</a><br>
                        ...
                        <?php $no = 1; ?>
                            <?php foreach ($topologi as $t) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?= base_url('/topologiSTI/updateTopologi'); ?>" method="POST">
                                            <input type="hidden" name="idTopologiUPDATE" value="<?= $t->idTopologi; ?>">
                                            <input class="btn btn-primary" type="submit" name="submit" value="Update">
                                        </form>
                                        <form action="<?= base_url('/topologiSTI/deleteTopologi'); ?>" method="POST">
                                            <input type="hidden" name="idTopologiDELETE" value="<?= $t->idTopologi; ?>">
                                            <input class="btn btn-alert" type="submit" name="submit" value="Delete">
                                        </form>
                                    </td>
                                </tr>
                            <?php } ?>
