          ...
          <li class="nav-item dropdown active">
            <a class="nav-link" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item active" href="<?= base_url('/typeAlat/viewType'); ?>">Type Alat</a>
                </div>
          </li>
          <li class="nav-item ">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="<?= base_url(); ?>typeAlat/addType" class="btn btn-primary">Add Type</a><br>
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                            <?php foreach($allType as $type) : ?>
                                <tr>
                                    <th scope="row"><?= $i; ?></th>
                                    <td><?= htmlentities($type->type); ?></td>
                                    <td>
                                        <form action="<?= base_url(); ?>typeAlat/updateType" method="post">
                                            <input type="hidden" name="idType" value="<?= $type->idType ?>">
                                            <input class="btn btn-primary" type="submit" name="submit" value="update">
                                        </form>
                                        <form action="<?= base_url(); ?>typeAlat/deleteType" method="post">
                                            <input type="hidden" name="idType" value="<?= $type->idType ?>">
