           ...
           <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">Transaksi Aset</p>
                  <h3 class="card-title"><?= $countTransaksiAset; ?>
                    <small>UP</small>
                  </h3>
                </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">Topologi</p>
                  <h3 class="card-title"><?= $countTopologi; ?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">date_range</i> Last 24 Hours
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h3 class="card-title"><?= $countMonitoring; ?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">date_range</i> Last 24 Hours
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <p class="card-category">Transaksi Link</p>
                  <h3 class="card-title"><?= $countTransaksiLink ?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">date_range</i> Last 24 Hours
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Table control admin</p>
                </div>
                      ...
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#profile" data-toggle="tab">
                            <i class="material-icons">bug_report</i> Topologi
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#messages" data-toggle="tab">
                            <i class="material-icons">code</i> Link
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#settings" data-toggle="tab">
                            <i class="material-icons">cloud</i> Merk Alat
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                      </ul>
                      ...
                      <tbody>
                        <?php $no = 1; ?>
                            ...
                            <tr>
                                <th scope="row"><?= $no++; ?></th>
                                <td><?= $l->namaLink; ?></td>
                                <td><?= $l->kapasitasLink; ?></td>
                                <td><?= $l->serviceLink; ?></td>
                                <td><?= $l->statusLink; ?></td>
                                <td><?= $l->keteranganLink; ?></td>
                            </tr>
                            <?php if($no == 3){
                            break;
                        }
