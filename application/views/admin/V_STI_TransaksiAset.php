              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <input class="form-control" type="text" id="keyword" placeholder="Cari sesuatu disini..."><br>
                    <a class="btn btn-primary" href="<?= base_url('/TransaksiAset/addTransaksiAset/'); ?>">Tambah Transaksi Aset</a><br>
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                            <?php foreach ($allTransaksiAset as $transaksiAset) : ?>
                                <tr>
                                    <td><?= $i; ?></td>
                                    <td><?= $transaksiAset->namaUnitL1; ?></td>
                                    <td><?= $transaksiAset->namaUnitL2; ?></td>
                                    <td><?= $transaksiAset->namaUnitL3; ?></td>
                                    <td><?= $transaksiAset->namaUnitL4; ?></td>
                                    <td><?= $transaksiAset->kategori; ?></td>
                                    <td><?= $transaksiAset->merk; ?></td>
                                    <td><?= $transaksiAset->type; ?></td>
                                    <td><?= $transaksiAset->spesifikasiAset; ?></td>
                                    <td>
                                        <form action="<?= base_url('/TransaksiAset/updateTransaksiAset/'); ?>" method="post">
                                            <input type="hidden" name="idTransaksi" value="<?= $transaksiAset->idTransaksi; ?>">
                                            <input class="btn btn-primary" type="submit" name="submit" value="Update">
                                        </form>
                                        <form action="<?= base_url('/TransaksiAset/deleteTransaksiAset/'); ?>" method="post">
                                            <input type="hidden" name="idTransaksi" value="<?= $transaksiAset->idTransaksi; ?>">
                                            <input class="btn btn-alret" type="submit" name="submit" value="Delete">
                                        </form>
                                    </td>
                                </tr>
                                <?php $i++; ?>
...
<script>
    $(document).ready(function() {
        $("#keyword").on("keyup", function() {
            ...
            $("tbody[name='bodyTransaksi'] tr").filter(function() {
