          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
					<form action="<?= base_url('/UnitLV2/updateUnitLV2Process'); ?>" method="post">
						<input type="hidden" name="idL2" value="<?= $unitLV2->idL2; ?>">
						<input class="form-control" type="text" name="namaUnitL2" placeholder="Nama unit level 2" value="<?= $unitLV2->namaUnitL2; ?>">
						<?= form_error('namaUnitL2'); ?><br>
						<input class="form-control" type="text" name="singkatanL2" placeholder="Singkatan unit level 2" value="<?= $unitLV2->singkatanL2; ?>">
						<?= form_error('singkatanL2'); ?><br>
						<input class="form-control" type="text" name="koordinatL2" placeholder="Koordinat unit level 2" value="<?= $unitLV2->koordinatL2; ?>">
