            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Uptadekan LINK dibawah ini </p>
                </div>
                <div class="card-body">
                <form action="<?= base_url(); ?>Link/updateLinkProcess" method="post">
                    <input type="hidden" name="SID" value="<?= $link->SID; ?>">

                    <input class="form-control" style="color: inherit;" type="text" name="namaLink" placeholder="Nama Link" value="<?= $link->namaLink; ?>">
                    <?= form_error('namaLink'); ?><br>

                    <input class="form-control"  style="color: inherit;" type="number" name="kapasitasLink" placeholder="Kapasitas Link" value="<?= $link->kapasitasLink; ?>">
                    <?= form_error('kapasitasLink'); ?><br>

                    <input class="form-control" style="color: inherit;" type="text" name="serviceLink" placeholder="Service Link" value="<?= $link->serviceLink; ?>">
                    <?= form_error('serviceLink'); ?><br>

                    <select class="form-control" style="color: inherit;" name="statusLink">
                        <option class="form-control dropdown-item" style="color: inherit;" value="">Status Link</option>
                        <option class="form-control dropdown-item" style="color: inherit;" value="Aktif" <?php if ($link->statusLink == 'Aktif') echo 'selected'; ?>>Aktif</option>
                        <option class="form-control dropdown-item" style="color: inherit;" value="Tidak Aktif" <?php if ($link->statusLink == 'Tidak Aktif') echo 'selected'; ?>>Tidak Aktif</option>
                    </select>
                    <?= form_error('statusLink'); ?><br>

                    <input class="form-control" style="color: inherit;" type="text" name="keteranganLink" placeholder="Keterangan Link" value="<?= $link->keteranganLink; ?>">
                    <?= form_error('keteranganLink'); ?><br>
