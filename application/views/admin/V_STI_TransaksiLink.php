              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="<?= base_url(); ?>TransaksiLink/addTransaksiLink" class="btn btn-primary">Add Transaksi Link</a>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                            <?php foreach ($transaksilink as $tl) : ?>
                                <tr>
                                    <td><?= $i; ?></td>
                                    <td><?= $tl->namaUnitL1; ?></td>
                                    <td><?= $tl->namaUnitL2; ?></td>
                                    ...
                                    <td><?= $tl->namaUnitL4; ?></td>
                                    <td><?= $tl->namaLink; ?></td>
                                    <td><?= $tl->kapasitasLink; ?></td>
                                    <td><?= $tl->serviceLink; ?></td>
                                    <td><?= $tl->statusLink; ?></td>
                                    <td><?= $tl->keteranganLink; ?></td>
                                    <td>
                                        <form action="<?= base_url(); ?>TransaksiLink/updateTransaksiLink/" method="post">
                                            <input type="hidden" name="idTL" value="<?= $tl->idTL; ?>">
                                            <input class="btn btn-primary" type="submit" name="submit" value="update">
                                        </form>
                                        <form action="<?= base_url(); ?>TransaksiLink/deleteTransaksiLink/" method="post">
                                            <input type="hidden" name="idTL" value="<?= $tl->idTL; ?>">
