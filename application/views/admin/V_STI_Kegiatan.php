              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    <form action="<?= base_url('/kegiatanSTI/updateKegiatan/'); ?>" method="POST">
                        <input type="hidden" name="idKegiatanUPDATE" value="<?= $kegiatan->idKegiatan; ?>">
                        <input class="btn btn-primary" type="submit" name="submitUPDATE" value="Update"><br><br>
                    </form>
                        <div class="col-md-auto">
                          <div class="alert alert-info">
                            <label class="form-control"> Nama Publisher : <?= $kegiatan->username; ?></label>
                            <center><h1><?= $kegiatan->judulKegiatan; ?></h1>
                            <img src="<?= base_url('assets/kegiatan/') . $kegiatan->gambarKegiatan; ?>" alt=""></center>
