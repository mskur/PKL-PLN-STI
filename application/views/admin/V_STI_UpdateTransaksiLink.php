            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Udpate Tranksaksi Link</h4>
                  <p class="card-category"> Udpate data Tranksaksi Link dibawah ini </p>
                </div>
                <div class="card-body">
                <form action="<?= base_url(); ?>TransaksiLink/UpdateTransaksiLinkProcess" method="post">
                    <input type="hidden" name="idTL" value="<?= $transaksilink->idTL; ?>">
                    <div class="form-group">
                        <label for="idL1">Unit LV1</label>
                        <select class="form-control" style="color: inherit;" name="idL1" id="idL1">
                            <option value="">-- Pilih Unit LV1 --</option>
                            <?php foreach ($unitlv1 as $ulv1) : ?>
                                <?php if($ulv1->idL1 == $transaksilink->idL1) : ?>
                                    <option class="form-control dropdown-item" style="color: inherit;" value="<?= $ulv1->idL1 ?>" selected><?= $ulv1->namaUnitL1; ?></option>
                                <?php else : ?>
                                    <option class="form-control dropdown-item" style="color: inherit;" value="<?= $ulv1->idL1 ?>"><?= $ulv1->namaUnitL1; ?></option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('idL1'); ?><br>
                    ...
                    <div class="form-group">
                        <label for="idL2">Unit LV2</label>
                        <select class="form-control" style="color: inherit;" name="idL2" id="idL2">
                            <option class="form-control dropdown-item" style="color: inherit;" value="">-- Pilih Unit LV2 --</option>
                            <?php foreach ($unitlv2 as $ulv2) : ?>
                                <?php if($ulv2->idL2 == $transaksilink->idL2) : ?>
                                    <option class="form-control dropdown-item" style="color: inherit;" value="<?= $ulv2->idL2 ?>" selected><?= $ulv2->namaUnitL2; ?></option>
                                <?php else : ?>
                                    <option class="form-control dropdown-item" style="color: inherit;" value="<?= $ulv2->idL2 ?>"><?= $ulv2->namaUnitL2; ?></option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('idL2'); ?><br>
                    ...
                    <div class="form-group">
                        <label for="idL3">Unit LV3</label>
                        <select class="form-control" style="color: inherit;" name="idL3" id="idL3">
                            <option value="">-- Pilih Unit LV3 --</option>
                            <?php foreach ($unitlv3 as $ulv3) : ?>
                                <?php if($ulv3->idL3 == $transaksilink->idL3) : ?>
                                    <option class="form-control dropdown-item" style="color: inherit;" value="<?= $ulv3->idL3 ?>" selected><?= $ulv3->namaUnitL3; ?></option>
                                <?php else : ?>
                                    <option class="form-control dropdown-item" style="color: inherit;" value="<?= $ulv3->idL3 ?>"><?= $ulv3->namaUnitL3; ?></option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('idL3'); ?><br>
                    ...
                    <div class="form-group">
                        <label for="idL4">Unit LV4</label>
                        <select class="form-control" style="color: inherit;" name="idL4" id="idL4">
                            <option class="form-control dropdown-item" style="color: inherit;" value="">-- Pilih Unit LV4 --</option>
                            <?php foreach ($unitlv4 as $ulv4) : ?>
                                <?php if($ulv4->idL4 == $transaksilink->idL4) : ?>
                                    <option class="form-control dropdown-item" style="color: inherit;" value="<?= $ulv4->idL4 ?>" selected><?= $ulv4->namaUnitL4; ?></option>
                                <?php else : ?>
                                    <option value="<?= $ulv4->idL4 ?>"><?= $ulv4->namaUnitL4; ?></option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('idL4'); ?><br>
                    ...
                    <div class="form-group">
                        <label for="SID">Nama Link</label>
                        <select class="form-control" style="color: inherit;" name="SID" id="SID">
                            <option value="">-- Pilih Link --</option>
                            <?php foreach ($link as $l) : ?>
                                <?php if($l->SID == $transaksilink->SID) : ?>
                                    <option class="form-control" style="color: inherit;" value="<?= $l->SID ?>" selected><?= $l->namaLink; ?></option>
                                <?php else : ?>
                                    <option class="form-control" style="color: inherit;" value="<?= $l->SID ?>"><?= $l->namaLink; ?></option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('SID'); ?><br>
