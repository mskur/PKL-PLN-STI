          ...
          <li class="nav-item dropdown active">
            <a class="nav-link" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item active" href="<?= base_url('/merkAlat/viewMerk'); ?>">Merk Alat</a>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Update Merk Alat</h4>
                  <p class="card-category"> Update data Merk Alat dibawah ini </p>
                </div>
                <div class="card-body">
                <form action="<?= base_url('/merkAlat/updateMerkProcess'); ?>" method="post">
				    <input class="form-control" type="hidden" name="idMerk" value="<?= $merk->idMerk; ?>">
				    <input class="form-control" type="text" name="merk" placeholder="merk" value="<?= $merk->merk; ?>">
				    <?= form_error('merk'); ?><br>
