              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                     <a href="<?= base_url(); ?>kategoriAlat/addKategori" class="btn btn-primary">Add Kategori</a>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                            <?php foreach($allKategori as $ktgr) : ?>
                                <tr>
                                    <th scope="row"><?= $i; ?></th>
                                    <td><?= $ktgr->kategori; ?></td>
                                    <td>
                                        <form action="<?= base_url(); ?>kategoriAlat/updateKategori" method="post">
                                            <input type="hidden" name="idKategori" value="<?= $ktgr->idKategori ?>">
                                            <input class="btn btn-primary" type="submit" name="submit" value="update">
                                        </form>
                                        <form action="<?= base_url(); ?>kategoriAlat/deleteKategori" method="post">
                                            <input type="hidden" name="idKategori" value="<?= $ktgr->idKategori ?>">
