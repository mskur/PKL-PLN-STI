          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
					<form action="<?= base_url('/UnitLV1/addUnitLV1Process'); ?>" method="post">
					    <input class="form-control" type="text" name="namaUnitL1" placeholder="Nama unit level 1" value="<?= set_value('namaUnitL1'); ?>">
					    <?= form_error('namaUnitL1'); ?><br>
					    <input class="form-control" type="text" name="singkatanL1" placeholder="Singkatan unit level 1" value="<?= set_value('singkatanL1'); ?>">
					    <?= form_error('singkatanL1'); ?><br>
					    <input class="form-control" type="text" name="koordinatL1" placeholder="Koordinat unit level 1" value="<?= set_value('koordinatL1'); ?>">
