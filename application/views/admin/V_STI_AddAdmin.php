            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Form tabel tambah admin</p>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('/adminSTI/addAdminAction'); ?>" method="post">
                        ...
                        <select style="color: blue;" class="form-control" name="level" id="level">
