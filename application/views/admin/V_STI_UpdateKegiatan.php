            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Update Data Kegiatan</h4>
                  <p class="card-category"> Updatekan data kegiatan pada dibawah ini</p>
                </div>
                <div class="card-body">
                  <?= $this->session->flashdata('message'); ?>
                 <form action="<?= base_url('/kegiatanSTI/updateKegiatanAction'); ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="idKegiatan" value="<?= $kegiatan->idKegiatan; ?>"><br>
                    <input class="form-control" type="file" name="gambarKegiatan" placeholder="Gambar Kegiatan"><br>
                    <img src="<?= base_url('assets/kegiatan/' . $kegiatan->gambarKegiatan)?>" width="100px"><br>
                    <input class="form-control" type="hidden" name="oldGambarKegiatan" value="<?= $kegiatan->gambarKegiatan; ?>"></input><br>
                    <input class="form-control" required type="text" name="judulKegiatan" placeholder="Judul Kegiatan" value="<?= $kegiatan->judulKegiatan?>"><br>
                    <?= form_error('judulKegiatan'); ?>
                    <!-- <input type="text" name="deskripsiKegiatan" placeholder="DeskripsiKegiatan" value="<?//= $kegiatan->deskripsiKegiatan?>"><br> -->
                    <textarea required id="summernote" name="deskripsiKegiatan" placeholder="Deskripsi Kegiatan" required><?= $kegiatan->deskripsiKegiatan?></textarea><br>
                    <?= form_error('deskripsiKegiatan'); ?>
  ...
  <script>
    $(document).ready(function() {
        $('#summernote').summernote({
            ...
            height: "300px",
            //batasi upload tidak lebih dari 1 file
            callbacks: {
                onImageUpload: function(image) {
                    //if upload file lebih dari 1
        ...
        function deleteImage(src) {
            $.ajax({
                data: {src : src},
                type: "POST",
                url: "<?= base_url('kegiatanSTI/summernoteDelete')?>",
                cache: false,
