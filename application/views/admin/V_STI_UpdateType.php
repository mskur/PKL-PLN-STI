            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Update data Type dibawah ini </p>
                </div>
                <div class="card-body">
					<form action="<?= base_url('/typeAlat/updateTypeProcess'); ?>" method="post">
					    <input type="hidden" name="idType" value="<?= $type->idType; ?>">
					    <input class="form-control" type="text" name="type" placeholder="type" value="<?= $type->type; ?>">
					    <?= form_error('type'); ?><br>
