            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Update akun Admin dibawah ini </p>
                </div>
                <div class="card-body">
                   <?php foreach($admin as $a){ ?>
                        <form action="<?php echo base_url('adminSTI/updateAdminAction') ?>" method="post">
                            <label for="username">Username</label>
                            <input class="form-control" readonly name="username" value="<?php echo $a->username ?>"><br>
                            <label for="password">Password</label>
                            <input class="form-control" type="password" name="password" id="password"><br>
                            <input class="form-control" type="hidden" name="passwordOLD" value="<?php echo $a->password ?>">
                            <label for="level">Level</label>
                            <select class="form-control" style="color: inherit;" name="level" id="level">
                                <option class="form-control dropdown-item-right" style="color: inherit;" value="superadmin" <?php if($a->level == 'superadmin'){echo 'selected';} ?>>Superadmin</option>
                                <option class="form-control dropdown-item-right"  style="color: inherit;" value="admin" <?php if($a->level == 'admin'){echo 'selected';} ?>>Admin</option>
                            </select><br>
