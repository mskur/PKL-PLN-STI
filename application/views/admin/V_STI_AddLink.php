            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Tambah LINK</h4>
                  <p class="card-category"> Tambahkan LINK dibawah ini </p>
                </div>
                <div class="card-body">
                <form action="<?= base_url(); ?>Link/addLinkProcess" method="post">
                    <input class="form-control" type="text" name="namaLink" placeholder="Nama Link" value="<?= set_value('namaLink'); ?>"><br>
                    <?= form_error('namaLink'); ?>
                    
                    <input class="form-control" type="number" name="kapasitasLink" placeholder="Kapasitas Link" value="<?= set_value('kapasitasLink'); ?>">
                    <?= form_error('kapasitasLink'); ?> <br>

                    <input class="form-control" type="text" name="serviceLink" placeholder="Service Link" value="<?= set_value('serviceLink'); ?>">
                    <?= form_error('serviceLink'); ?><br>

                    <select class="form-control" name="statusLink" style="color: inherit">
                        <option class="form-control dropdown-item" style="color: inherit" value="">Status Link</option>
                        <option class="form-control dropdown-item" style="color: inherit" value="Aktif">Aktif</option>
                        <option class="form-control dropdown-item" style="color: inherit" value="Tidak Aktif">Tidak Aktif</option>
                    </select><br>
                    <?= form_error('statusLink'); ?>

                    <input class="form-control" type="text" name="keteranganLink" placeholder="Keterangan Link" value="<?= set_value('keteranganLink'); ?>">
