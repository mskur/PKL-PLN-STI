            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Tambah Tranksaksi Link</h4>
                  <p class="card-category"> Tambahkan Tranksaksi Link dibawah ini </p>
                </div>
                <div class="card-body">
                <form action="<?= base_url(); ?>TransaksiLink/addTransaksiLinkProcess" method="post">
                    <div class="form-group">
                        <label for="idL1">Unit LV1</label>
                        <select style="color: inherit;" class="form-control" name="idL1" id="idL1">
                            <option style="color: inherit;" value="">-- Pilih Unit LV1 --</option>
                            <?php foreach ($unitlv1 as $ulv1) : ?>
                                <option style="color: inherit;" value="<?= $ulv1->idL1 ?>"><?= $ulv1->namaUnitL1; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('idL1'); ?><br>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" style="color: inherit;" name="idL2" id="idL2">
                            <option style="color: inherit;" value="">-- Pilih Unit LV2 --</option>
                            <?php foreach ($unitlv2 as $ulv2) : ?>
                                <option style="color: inherit;" value="<?= $ulv2->idL2 ?>"><?= $ulv2->namaUnitL2; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('idL2'); ?><br>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" style="color: inherit;" name="idL3" id="idL3">
                            <option style="color: inherit;" value="">-- Pilih Unit LV3 --</option>
                            <?php foreach ($unitlv3 as $ulv3) : ?>
                                <option style="color: inherit;" value="<?= $ulv3->idL3 ?>"><?= $ulv3->namaUnitL3; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('idL3'); ?><br>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" style="color: inherit;" name="idL4" id="idL4">
                            <option style="color: inherit;" value="">-- Pilih Unit LV4 --</option>
                            <?php foreach ($unitlv4 as $ulv4) : ?>
                                <option style="color: inherit;" value="<?= $ulv4->idL4 ?>"><?= $ulv4->namaUnitL4; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('idL4'); ?><br>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" style="color: inherit;" name="SID" id="SID">
                            <option style="color: inherit;" value="">-- Pilih Nama Link --</option>
                            <?php foreach ($link as $l) : ?>
                                <option style="color: inherit;" value="<?= $l->SID ?>"><?= $l->namaLink; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('SID'); ?><br>
                    </div>
