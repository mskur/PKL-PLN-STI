        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown  active">
            <a class="nav-link" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item active" href="<?= base_url('/kategoriAlat/viewKategori'); ?>">Alat</a>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Update kategori alat dibawah ini</p>
                </div>
                <div class="card-body">
                  <form action="<?= base_url('/kategoriAlat/updateKategoriProcess'); ?>" method="post">
				    <input class="form-control" type="hidden" name="idKategori" value="<?= $kategori->idKategori; ?>">
				    <input class="form-control" type="text" name="kategori" placeholder="Kategori" value="<?= $kategori->kategori; ?>">
				    <?= form_error('kategori'); ?><br>
