              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="<?= base_url(); ?>Link/addLink" class="btn btn-primary">Add Link</a><br>
                      ...
                      <tbody>
                        <?php $no = 1; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?= base_url(); ?>Link/updateLink" method="post">
                                        <input type="hidden" name="SID" value="<?= $l->SID; ?>">
                                        <input class="btn btn-primary" type="submit" name="submit" value="Update">
                                    </form>
                                    <form action="<?= base_url(); ?>Link/deleteLink" method="post">
                                        <input type="hidden" name="SID" value="<?= $l->SID; ?>">
