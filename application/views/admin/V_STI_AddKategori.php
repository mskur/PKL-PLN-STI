            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Tambahkan kategori dibawah ini</p>
                </div>
                <div class="card-body">
                <form action="<?= base_url('/kategoriAlat/addKategoriProcess'); ?>" method="post">
				    <input class="form-control" type="text" name="kategori" placeholder="Kategori" value="<?= set_value('kategori'); ?>">
