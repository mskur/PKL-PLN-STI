              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="<?= base_url(); ?>UnitLV1/addUnitLV1" class="btn btn-primary">Add Unit Level 1</a><br>
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                            ...
                            <tr>
                                ...
                                <td><?= $u->koordinatL1; ?></td>
                                <td>
                                    <form action="<?= base_url(); ?>UnitLV1/updateUnitLV1" method="post">
                                        <input type="hidden" name="idL1" value="<?= $u->idL1; ?>">
                                        <input class="btn btn-primary" type="submit" name="submit" value="Update">
                                    </form>
                                    <form action="<?= base_url(); ?>UnitLV1/deleteUnitLV1" method="post">
                                        <input type="hidden" name="idL1" value="<?= $u->idL1; ?>">
