          ...
          <li class="nav-item dropdown active">
            <a class="nav-link" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item active" href="<?= base_url('/unitLV4/viewUnitLV4'); ?>">Unit LV4</a>
                </div>
          </li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
					<form action="<?= base_url('/UnitLV4/addUnitLV4Process'); ?>" method="post">
					    <input class="form-control" type="text" name="namaUnitL4" placeholder="Nama unit level 4" value="<?= set_value('namaUnitL4'); ?>">
					    <?= form_error('namaUnitL4'); ?><br>
					    <input class="form-control" type="text" name="singkatanL4" placeholder="Singkatan unit level 4" value="<?= set_value('singkatanL4'); ?>">
					    <?= form_error('singkatanL4'); ?><br>
					    <input class="form-control" type="text" name="koordinatL4" placeholder="Koordinat unit level 4" value="<?= set_value('koordinatL4'); ?>">
