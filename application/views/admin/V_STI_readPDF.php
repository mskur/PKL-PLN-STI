                    ...
                    <?= $this->session->flashdata('message'); ?>
                        <div class="col-md-auto">
                          <div class="alert alert-info">
                          	<center><h1>MEMBACA TOPOLOGI <?= $topologi->judulTopologi; ?></h1></center>
                            <embed src="<?= base_url('assets/topologi/'.$topologi->fileTopologi); ?>" type="application/pdf" width="100%" height="600px" />
                          </div>
                        </div>    
                  </div>
                </div>
