              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="<?= base_url(); ?>UnitLV2/addUnitLV2" class="btn btn-primary">Add Unit Level 2</a><br>
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                            ...
                            <tr>
                                ...
                                <td><?= $u->koordinatL2; ?></td>
                                <td>
                                    <form action="<?= base_url(); ?>UnitLV2/updateUnitLV2" method="post">
                                        <input type="hidden" name="idL2" value="<?= $u->idL2; ?>">
                                        <input class="btn btn-primary" type="submit" name="submit" value="Update">
                                    </form>
                                    <form action="<?= base_url(); ?>UnitLV2/deleteUnitLV2" method="post">
                                        <input type="hidden" name="idL2" value="<?= $u->idL2; ?>">
