            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Tambah Unit 1 </h4>
                  <p class="card-category"> Tambahkan Unit 1 dibawah ini </p>
                </div>
                <div class="card-body">
					<form action="<?= base_url('/UnitLV3/addUnitLV3Process'); ?>" method="post">
					    <input class="form-control" type="text" name="namaUnitL3" placeholder="Nama unit level 3" value="<?= set_value('namaUnitL3'); ?>">
					    <?= form_error('namaUnitL3'); ?><br>
					    <input class="form-control" type="text" name="singkatanL3" placeholder="Singkatan unit level 3" value="<?= set_value('singkatanL3'); ?>">
					    <?= form_error('singkatanL3'); ?><br>
					    <input class="form-control" type="text" name="koordinatL3" placeholder="Koordinat unit level 3" value="<?= set_value('koordinatL3'); ?>">
