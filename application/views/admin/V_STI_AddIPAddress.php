            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Tambah IP Addres</h4>
                  <p class="card-category"> Tambahkan IP Addres dibawah ini </p>
                </div>
                <div class="card-body">
                <?php echo $this->session->flashdata('message'); ?>
                    <?php echo form_open('monitoringSTI/addIPAddress'); ?>
					    <label class="form-control" for="ipAddress">IP Address</label>
