              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <a href="<?= base_url(); ?>UnitLV4/addUnitLV4" class="btn btn-primary">Add Unit Level 4</a><br>
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                            ...
                            <tr>
                                ...
                                <td><?= $u->koordinatL4; ?></td>
                                <td>
                                    <form action="<?= base_url(); ?>UnitLV4/updateUnitLV4" method="post">
                                        <input type="hidden" name="idL4" value="<?= $u->idL4; ?>">
                                        <input class="btn btn-primary" type="submit" name="submit" value="Update">
                                    </form>
                                    <form action="<?= base_url(); ?>UnitLV4/deleteUnitLV4" method="post">
                                        <input type="hidden" name="idL4" value="<?= $u->idL4; ?>">
