            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Update Topologi</h4>
                  <p class="card-category"> Update Topologi dibawah ini </p>
                </div>
                <div class="card-body">
				...
				<form action="<?= base_url('/topologiSTI/updateTopologiAction'); ?>" method="POST" enctype="multipart/form-data">
				    <input type="hidden" name="idTopologi" value="<?= $topologi->idTopologi; ?>">
				    <input class="form-control" type="text" name="judulTopologi" placeholder="Judul Topologi" value="<?= $topologi->judulTopologi; ?>" ><br>
				    <h4>Get old file pdf</h4>
				    <input class="form-control" type="hidden" name="oldFileTopologi" value="<?= $topologi->fileTopologi; ?>">
				    <input class="form-control" type="file" name="fileTopologi" placeholder="File Topologi" ><br>
