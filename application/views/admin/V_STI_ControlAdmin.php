              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                      ...
                      <tbody>
                        <?php foreach ($admin as $adm) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php 
                                    if ($adm->username == $this->session->userdata('username')) {
                                        echo "NULL";
                                    } else {
                                    ?>
                                        <form action="<?= base_url('/adminSTI/updateAdmin'); ?>" method="post">
                                            <input type="hidden" name="usernameUPDATE" value="<?= $adm->username; ?>">
                                            <button class="btn btn-primary" type="submit" name="update">Update</button>
                                        </form>
                                        <form action="<?= base_url('/adminSTI/deleteAdmin'); ?>" method="post">
                                            <input type="hidden" name="usernameDELETE" value="<?= $adm->username; ?>">
                                            <button class="btn btn-alret" type="submit" name="delete">Delete</button>
                                        </form>
                                    <?php } ?>
                                </td>
                            </tr>
                    ...
                    <a class="btn btn-primary" href="<?= base_url('/adminSTI/addAdmin'); ?>">Tambah Admin</a>
                  </div>
                </div>
              </div>
            </div>
