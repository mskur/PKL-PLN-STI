          ...
          <li class="nav-item dropdown active">
            <a class="nav-link" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item active" href="<?= base_url('/unitLV1/viewUnitLV1'); ?>">Unit LV1</a>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Update Unit 1 </h4>
                  <p class="card-category"> Update data Unit 1 dibawah ini </p>
                </div>
                <div class="card-body">
                	<form action="<?= base_url('/UnitLV1/updateUnitLV1Process'); ?>" method="post">
					    <input class="form-control" type="hidden" name="idL1" value="<?= $unitLV1->idL1; ?>">
					    <input class="form-control" type="text" name="namaUnitL1" placeholder="Nama unit level 1" value="<?= $unitLV1->namaUnitL1; ?>">
					    <?= form_error('namaUnitL1'); ?><br>
					    <input class="form-control" type="text" name="singkatanL1" placeholder="Singkatan unit level 1" value="<?= $unitLV1->singkatanL1; ?>">
					    <?= form_error('singkatanL1'); ?><br>
					    <input class="form-control" type="text" name="koordinatL1" placeholder="Koordinat unit level 1" value="<?= $unitLV1->koordinatL1; ?>">
					    <?= form_error('koordinatL1'); ?><br>
